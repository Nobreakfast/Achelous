...
if __name__ == "__main__":
    ...
    parser.add_argument("--MTU_in", default=[1, 1], type=list, help="MTU input ratio")
    parser.add_argument(
        "--MTU_out", default=[1, 1, 1, 1, 1], type=list, help="MTU output ratio"
    )
    ...
    if args.pm > 0:
        ...
        pruner = BasePruner(
            ...
            algo_args={
                ...
                "MTU": {
                    "input_0": args.MTU_in[0],
                    "input_1": args.MTU_in[1],
                    # "output_0": args.MTU_out[0],  # det_0
                    # "output_1": args.MTU_out[1],  # det_1
                    # "output_2": args.MTU_out[2],  # det_2
                    # "output_3": args.MTU_out[3],  # se_seg
                    # "output_4": args.MTU_out[4],  # lane_seg
                },
            },
        )
        pruner.algorithm.run(args.pm)
        pruner.prune()
